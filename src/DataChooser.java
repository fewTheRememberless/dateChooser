...
public class DataChooser extends JFrame implements ActionListener, Runnable {
	...
	static String[] MESI_NOMI = { "Gennaio", "Febbraio", "Marzo", "Aprile", "Maggio", "Giugno", "Luglio", "Agosto",
	...
	protected DataChooser() {
		...
		card = new CardLayout();
		more = new JButton(
				new ImageIcon(new ImageIcon("plus.png").getImage().getScaledInstance(15, 15, Image.SCALE_DEFAULT)));
		less = new JButton(
				new ImageIcon(new ImageIcon("minus.png").getImage().getScaledInstance(15, 15, Image.SCALE_DEFAULT)));
		manual = new JButton("inserimento manuale");
		confirm = new JButton(
				new ImageIcon(new ImageIcon("check.png").getImage().getScaledInstance(15, 15, Image.SCALE_DEFAULT)));
		previus = new JButton(new ImageIcon(
				new ImageIcon("double-chevron_LX.png").getImage().getScaledInstance(25, 135, Image.SCALE_DEFAULT)));
		next = new JButton(new ImageIcon(
				new ImageIcon("double-chevron.png").getImage().getScaledInstance(25, 135, Image.SCALE_DEFAULT)));
		app = LocalDate.now();
		date = new JLabel();
		cont = 0;
		prova = new JPanel();
...
//	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o == confirm) {
			...
			if (cont == 2) {
				// app = new
				// LocalDate(app.getDayOfMonth(),app.getMonthValue(),app.getYear()+15);
				int a = app.getYear();
